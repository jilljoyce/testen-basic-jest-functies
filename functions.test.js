//importeer de functie vanuit functions.js
...
test('User should be Brad Traversy object', () => {
    expect(functions.createUser()).toStrictEqual({firstName: 'Brad', lastName: 'Traversy'});    //if it should pass with deep equality, replace "toBe" with "toStrictEqual"
});

// Tests zijn eigenlijk gewoon functies. Om dat te laten zien laten we je
// nu tests maken die werken zonder input van buitenaf:

//! the functions are not used as example in the example below
